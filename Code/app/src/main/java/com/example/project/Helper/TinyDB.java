...
public class TinyDB {
    ...
    public ArrayList<foodBean> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<foodBean> playerList = new ArrayList<foodBean>();

        for (String jObjString : objStrings) {
            foodBean player = gson.fromJson(jObjString, foodBean.class);
    ...
    public void putListObject(String key, ArrayList<foodBean> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (foodBean player : playerList) {
